...
class CuentaTest {
    ...
    void testNombreCuenta(){
        ...
        // A todos los métodos assertions se le puede pasar un mensaje como argumento que complementa la prueba, pero al pasarse de forma literal
    ...
    @Test
    @DisplayName("probando el saldo de la cuenta corriente, que no se nulo, mayor que cero, valor esperado")
    ...
    @Test
    @DisplayName("testeando referecias que sean iguales con el método equals.")
    ...
    void testRelacionBancoCuenta() {
        //con fail() se puede forzar el error de la prueba
        fail();
        Cuenta cuenta1 = new Cuenta("Jhon Doe", new BigDecimal("2500"));
        Cuenta cuenta2 = new Cuenta("Andres", new BigDecimal("1500.8989"));
