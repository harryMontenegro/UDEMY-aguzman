package javier_vazquez.seccion4._29.mr_de_instancia_de_un_objeto_arbitrario;

import javier_vazquez.seccion4._29.mr_de_instancia_de_un_objeto_arbitrario.modelos.Persona;
import javier_vazquez.seccion4._29.mr_de_instancia_de_un_objeto_arbitrario.utilerias.ProveedorComparaciones;
...
public class Principal {
    public static void main(String[] args) {
        ...
        Collections.sort(personas, Persona::compararPorEdad2);//Método referenciado a métodos de instancias de un objeto arbitrario
        System.out.println("Personas ordenadas por edad: ");
        personas.forEach(System.out::println);
        System.out.println();
    }
