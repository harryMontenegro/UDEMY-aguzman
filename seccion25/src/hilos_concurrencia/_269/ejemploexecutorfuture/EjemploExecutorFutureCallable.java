...
public class EjemploExecutorFutureCallable {
    public static void main(String[] args) throws InterruptedException, ExecutionException, TimeoutException {
        ...
        System.out.println("Obteniendo resultado de la tarea: " + resultado.get());// Se obtiene el resultado, pero bloquea el Thread actual hasta que finalice la tarea (tiene un delay de 3 segundos)
