package api_collections._2_ArrayList._250;

import api_collections._2_ArrayList._250.modelo.Alumno;
...
public class EjemploLinkedList {
    public static void main(String[] args) {
        ...
        //Con ListIterator<> podemos recorrer el LinkedList<> bien sea adelante o atrás con los respectivos métodos
        //Si se inicia con hasPrevious() al principio de la iteración dara error, el curso al menos debe haber avanzado una posición para usar hasPrevious().
        ListIterator<Alumno> li = enlazada.listIterator();
        while (li.hasNext()){
            //Con li.next() obtenemos el elemento movemos el cursor al siguiente elemento.
            Alumno alumno = li.next();
            System.out.println(alumno);
        }
        System.out.println("======================== Previous");
        while (li.hasPrevious()){
            //Con li.previous() obtenemos el elemento movemos el cursor al elemento anterior.
