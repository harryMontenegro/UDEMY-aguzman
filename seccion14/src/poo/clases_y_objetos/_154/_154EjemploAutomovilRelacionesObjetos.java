package poo.clases_y_objetos._154;


public class _154EjemploAutomovilRelacionesObjetos {
    public static void main(String[] args) {
        ...
        Rueda[] ruedaNissan = {new Rueda("Pirelli", 20, 11.5),
        ...
        Automovil nissan = new Automovil("Nissan", "Navara", Color.GRIS,
                new Motor(4.0, TipoMotor.DIESEL), new Estanque(50), bea, ruedaNissan);
        ...
        Automovil nissan2 = new Automovil("Nissan", "Navara", Color.GRIS,
                new Motor(3.5, TipoMotor.BENCINA), new Estanque(50), lalo,  ruedaNissan2);
